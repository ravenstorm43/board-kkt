...
@Controller
@RequestMapping("/sb-admin2")
public class HomeController {
    @Autowired
    MemoService memoService;  // MemoService 인터페이스의 구현체를 필드 주입

    @GetMapping("/")
    public String goHome() { return "/sb-admin2/index"; }
    @GetMapping("/buttons")
    public String goButtons() { return "/sb-admin2/buttons"; }
    @GetMapping("/cards")
    public String gocards() { return "/sb-admin2/cards"; }
}
